...
const props = defineProps({
    showEditInstallmentPaymentModal: Boolean,
    item: Object as PropType<{ id: number; type: string; installments?: string; paymentType: string; value: string } | null>,
});
...
watch(
    ...
    (newItem) => {
        if (newItem) {
            ...
            form.installments = newItem.installments ?? '';
...
const edit = (): void => {
    console.log('DASHBOARD :: Edit Installment Payment', form);
};
...
<template>
    <Modal :show="showEditInstallmentPaymentModal" @close="close" max-width="md">
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar pagamento parcelado?</h3>
