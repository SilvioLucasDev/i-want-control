...
defineProps({
    showAddWithdrawalsFromInvestmentsModal: Boolean,
});
...
const save = (): void => {
    console.log('DASHBOARD :: Save Withdrawals from Investments', form);
};
...
<template>
    <Modal :show="showAddWithdrawalsFromInvestmentsModal" @close="close" max-width="md">
        <div class="p-6">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Adicionar novo saque de investimento?</h3>
