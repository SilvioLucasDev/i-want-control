...
const props = defineProps({
    showEditVariableInputModal: Boolean,
...
const edit = (): void => {
    console.log('DASHBOARD :: Edit Variable Input', form);
};
...
<template>
    <Modal :show="showEditVariableInputModal" @close="close" max-width="md">
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar entrada variável?</h3>
