...
const props = defineProps({
    showEditWithdrawalsFromInvestmentsModal: Boolean,
    item: Object as PropType<{ id: number; type: string; value: string; recurrent?: boolean } | null>,
});
...
const edit = (): void => {
    console.log('DASHBOARD :: Edit Withdrawals from Investments', form);
};
...
<template>
    <Modal :show="showEditWithdrawalsFromInvestmentsModal" @close="close" max-width="md">
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar saque de investimento?</h3>
