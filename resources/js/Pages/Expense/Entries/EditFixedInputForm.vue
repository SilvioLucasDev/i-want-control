...
const props = defineProps({
    showEditFixedInputModal: Boolean,
    item: Object as PropType<{ id: number; type: string; value: string } | null>,
});
...
const edit = (): void => {
    console.log('DASHBOARD :: Edit Fixed Input', form);
};
...
<template>
    <Modal :show="showEditFixedInputModal" @close="close" max-width="md">
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar entrada fixa?</h3>
