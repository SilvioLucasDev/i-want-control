...
const save = (): void => {
    console.log('DASHBOARD :: Save Application', form);
};
</script>

<template>
    <Modal :show="showApplicationModal" @close="close" max-width="md">
        <div class="p-6">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Adicionar uma nova aplicação?</h3>
