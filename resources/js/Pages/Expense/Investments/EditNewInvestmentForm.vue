...
const props = defineProps({
    showEditNewInvestmentModal: Boolean,
...
const edit = (): void => {
    console.log('DASHBOARD :: Edit New Investment', form);
};
...
<template>
    <Modal :show="showEditNewInvestmentModal" @close="close" max-width="md">
        <div class="p-6">
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar novo investimento?</h3>
