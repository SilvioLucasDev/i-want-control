...
<template>
    <Teleport to="body">
        <div class="fixed right-5 top-5 z-50 flex flex-col gap-3">
            ...
            >
                <div v-if="showToast" class="flex min-w-[250px] max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow-lg backdrop-blur-md dark:bg-gray-800 dark:text-gray-400">
                    <div class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg" :class="toastClasses">
